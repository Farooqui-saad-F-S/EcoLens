...
function LogoMark() {
  return (
    <div className="relative h-8 w-8 shrink-0">
      ...
      <div className="absolute inset-[11px] rounded-full bg-linear-to-br/srgb from-cyan-accent to-blue-accent animate-pulse-soft" />
    </div>
  )
}
              ...
              >
                {({ isActive }) => (
                  <span className="flex flex-col items-center gap-1">
                    {label}
                    <span
                      className={`h-px w-full bg-linear-to-r/srgb from-cyan-accent to-emerald-accent transition-all duration-300 ${
