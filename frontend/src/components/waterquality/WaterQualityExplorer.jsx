      ...
      <div className="mt-9 grid gap-6 lg:grid-cols-[0.75fr_1.25fr]">
              ...
              return (
                <button
                  ...
                  className={`rounded-xl border px-3 py-3 text-left text-sm font-medium transition-all sm:px-4 ${
                    isActive
                      ? 'border-cyan-accent/40 bg-linear-to-r/srgb from-cyan-accent/15 to-blue-accent/10 text-white shadow-[0_0_24px_rgba(34,211,238,0.08)]'
        ...
        <GlassCard hover={false} glow="cyan" className="relative min-h-[390px]">
          ...
          <div className="relative">
            ...
            <div className="mt-8 rounded-2xl border border-cyan-accent/15 bg-linear-to-br/srgb from-cyan-accent/[0.08] to-blue-accent/[0.04] p-5 sm:p-6">
