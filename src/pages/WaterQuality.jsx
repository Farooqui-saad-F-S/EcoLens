  ...
  return (
    ...
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 top-20 -z-10 overflow-hidden">
        <div className="mx-auto h-72 max-w-5xl rounded-[50%] bg-gradient-to-r from-blue-accent/10 via-cyan-accent/15 to-emerald-accent/10 blur-3xl" />
      </div>
      ...
      <section aria-labelledby="parameter-title">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="relative hidden overflow-hidden rounded-2xl border border-cyan-accent/10 bg-gradient-to-br from-cyan-accent/[0.07] to-blue-accent/[0.03] p-6 lg:flex lg:min-h-[310px] lg:flex-col lg:justify-between">
